...
__all__ = ['RSNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
            'resnet152']
...
def resnet18(pretrained=False, **kwargs):
    """Constructs a RSNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = RSNet(BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet18']))
    return model

def resnet34(pretrained=False, **kwargs):
    """Constructs a RSNet-34 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = RSNet(BasicBlock, [3, 4, 6, 3], **kwargs)
    if pretrained:
